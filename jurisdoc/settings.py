...
INSTALLED_APPS = [
    ...
    "accounts","templates_app","petitions",
    "cadastro",
]
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=60),   # dev: 60 min
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),
    "AUTH_HEADER_TYPES": ("Bearer",),
}


SPECTACULAR_SETTINGS = {"TITLE":"JurisDoc API","VERSION":"0.1.0"}

CORS_ALLOWED_ORIGINS = os.getenv("CORS","http://localhost:5173").split(",")
