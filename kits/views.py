...
class KitViewSet(viewsets.ModelViewSet):
    ...
    def enviar_para_assinatura(self, request, pk=None):
        ...
        Cada documento é assinado individualmente pelo cliente; o link retornado
        é o do portal do JurisDoc, que conduz de um documento ao próximo.
        ...
        Retorna:
          {
            "status": str,
            "sign_url": str,   ← link único do portal de assinatura
